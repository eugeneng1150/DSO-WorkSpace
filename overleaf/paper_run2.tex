...
\begin{table}[H]
\centering
\caption{Phase 3 hardening sweep: GPT-5.4-nano, 4 fixed trolls, 30 rounds. Single run per condition. Cumulative honest-agent utility.}
...
Contracting                       &  16 & 0.5 \\
\bottomrule
\multicolumn{3}{@{}l@{}}{\footnotesize Judicial omitted: no GPT-5.4-nano run was conducted for this condition.}
\end{tabular}
\end{table}
