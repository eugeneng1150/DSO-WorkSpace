...
Research question: **What mechanism allows the survival of a society with self-interested agents?**
Concrete target: a marketplace society with trade and communication.
...
| Page | Description |
|------|-------------|
| [[cooperation-exploitation-llm]] | LLM policy synthesis in social dilemmas; dense social-metric feedback vs sparse reward; 5 reward-hacking attack classes |
| [[aris-autonomous-research]] | Autonomous ML research harness; cross-family adversarial review; plausible unsupported success failure mode |
...
| Page | Description |
|------|-------------|
| [[marketplace-society]] | **Core synthesis**: what mechanisms allow a marketplace society to survive — connects all papers to the research question |
| [[marketplace-spec]] | **Simulation spec**: concrete environment design, agent architecture, mechanism implementations, measurement plan |
| [[social-dilemmas]] | The fundamental problem: self-interested agents produce suboptimal collective outcomes; the 4–5 canonical games |
| [[cooperation-mechanisms]] | Contracting, Mediation, Repetition, Reputation — ranked by effectiveness; mechanism design for a marketplace |
| [[social-metrics]] | Efficiency, Equality, Sustainability, Peace — operationalizing what "societal survival" means |
