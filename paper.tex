...
Agents are embedded in a static trade network that constrains who can interact directly. Each agent is connected to 6--9 neighbours, with the following guarantees:
...
Each simulation run consists of $T = 30$ rounds. Each round proceeds through four phases:
